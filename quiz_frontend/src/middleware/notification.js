...
const EXCEPTION_LIST = [
    ...
    quizzes.GET_QUIZ_LEVEL.SUCCESS,
    quizzes.GET_QUIZ_RESULTS.SUCCESS,
    quizzes.DELETE_UNCOMPLETED_QUIZ_RESULTS.SUCCESS,
    user.USER_SIGNIN.SUCCESS,
    user.USER_SIGNOUT.SUCCESS,
    user.GET_USER_PASSED_QUIZZES.SUCCESS,
    user.GET_USER_QUIZ_RESULT.SUCCESS
];
